...
class MockTestCardsOnline extends StatefulWidget {
  final course courses;

  const MockTestCardsOnline({
    super.key,
    required this.courses,
  });

  @override
  State<MockTestCardsOnline> createState() => _MockTestCardsOnlineState();
}

class _MockTestCardsOnlineState extends State<MockTestCardsOnline> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text(
                "${widget.courses.name} Online Test ",
            ...
            Container(
              ...
              child: Row(
                children: [
                  Text(
                    "Rs. ${widget.courses.online_mock_price} /- Per Test",
                    style: MyStyles.card_blue_text,
                  ),
                ],
              ),
